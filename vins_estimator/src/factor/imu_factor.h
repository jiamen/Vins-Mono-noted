...
#include <ceres/ceres.h>
        ...
        // <误差项（P/V/Q/Ba/Bg 5*3 , T_w_bi(PQ两项7维), M_b_i(V/Ba/Bg三项9维) , T_w_bj(PQ两项7维), M_b_j(V/Ba/Bg三项9维) ）>
...
//delta_q = Qi.inverse() * Qj;
        ...
        if (jacobians)
        {
            ...
            Eigen::Matrix3d dp_dba = pre_integration->jacobian.template block<3, 3>(O_P, O_BA);    // 《VIO第3讲》 P70页，见标注
...
///                ROS_BREAK();
            ...
            if (jacobians[0])   // P/V/Q/Ba/Bg（5*3维） 五项残差对i时刻位姿（P/Q）求导
            {
            ...
            if (jacobians[1])   // P/V/Q/Ba/Bg（5*3维） 五项残差对i时刻V/Ba/Bg求导
            {
            ...
            jacobian_speedbias_i.block<3, 3>(O_R, O_BG - O_V) = -dq_dbg;
                ...
                // 《VIO第3讲》  P72页  rv对速度求导  公式（82）
                jacobian_speedbias_i.block<3, 3>(O_V, O_V - O_V) = -Qi.inverse().toRotationMatrix();
                jacobian_speedbias_i.block<3, 3>(O_V, O_BA - O_V) = -dv_dba;    // 公式（83）
            ...
            if (jacobians[2])       // P/V/Q/Ba/Bg（5*3维） 五项残差对j时刻位姿（P/Q）求导
            {
            ...
            if (jacobians[3])       // P/V/Q/Ba/Bg（5*3维） 五项残差对j时刻V/Ba/Bg求导
            {
